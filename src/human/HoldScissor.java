 ...
 * to show the graphic after adding the scissor to human hand
 */
public class HoldScissor extends HumanDecorator{
	private BufferedImage img;
	
	public HoldScissor(SimpleHuman h) {
		super(h);
	...
	private void drawScissor(Graphics2D g2) {
